...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I'm Rinshad Mon P, a creative professional specializing in
          content creation, script writing, and video editing. With a strong
          foundation in storytelling and visual communication, I bring ideas to
          life through engaging narratives, compelling visuals, and polished
          edits. I hold a B.Voc degree in Visual Communication, which has
          strengthened my understanding of media, design, and audience
          psychology.
          <br className="sm:block hidden" />
          My passion lies in transforming concepts into visually powerful
          stories— through creativity, clarity, and emotion. Let's collaborate
          and create impactful content together!
        </div>

        <div className="w-fit break-words">
          <Link
            href="mailto:rinshadpottengaden@gmail.com"
            target="_blank"
            rel="noreferrer"
