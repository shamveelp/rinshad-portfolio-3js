...
const experiences = [
  {
    ...
    company_name: "Star Plus 21",
    icon: "/assets/company/star-plus.svg",
    iconBg: "#E6DEDD",
    date: "2022 - 2024",
    points: [
      "Managed social media presence and content strategy for Star Plus 21.",
      "Created and curated engaging content across multiple platforms.",
      "Developed and executed social media campaigns to increase engagement.",
      "Monitored analytics and optimized content performance.",
    ],
  },
  {
    title: "Content Creator",
    company_name: "Self Employed",
    icon: "/assets/company/self-employed.svg",
    iconBg: "#E6DEDD",
    date: "2020 - 2024",
    points: [
      "Created and produced original video content for various platforms.",
      "Developed creative concepts and scripts for engaging content.",
      "Edited videos using professional editing software.",
      "Built and maintained a growing online presence and audience.",
    ],
  },
];
